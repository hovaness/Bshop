...
namespace Bshop.Controllers
{
    public class ClientController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,name,number,isRegular,visitings")] ClientModel clientModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,name,number,isRegular,visitings")] ClientModel clientModel)
        {
